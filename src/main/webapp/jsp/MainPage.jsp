    ...
    <div class="app">
      <div class="nav">
        ...
        <div class="notify-mess">
          <ul class="nm_list">
            <li class="nm_item">
              <a href="#" class="nm_link"><i class="nm_icon fa-solid fa-ellipsis"></i></a>
            </li>
            <li class="nm_item">
              <a href="Messenger.jsp" class="nm_link"><i class="nm_icon fa-solid fa-comments"></i></a>
            </li>
            <li class="nm_item">
              <a href="#" class="nm_link"><i class="nm_icon fa-solid fa-bell"></i></a>
            </li>
            <li class="nm_item">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="content__post">
              <textarea name="noidungpost" id="content_area" placeholder="Nguyên ơi, bạn đang nghĩ gì thế?"></textarea>
            </div>
