    ...
    <div class="app">
      ...
      <div class="header">
        <div class="cover_photo">
          <img src="../img/anhbia.jpg" alt="" />
          <a href="#" class="update_cover_photo">
        ...
        <div class="avt_info">
          <div class="img_info">
            ...
            <div class="info">
              <h1 class="name">Chí Nguyên</h1>
              <a href="#" class="number_friend">102 người bạn</a>
            </div>
          </div>
          <div class="profile_setting">
            <div class="setting_btn">
              <a href="#" class="add_story">
                <i class="fa-solid fa-plus"></i> Thêm vào tin
              </a>
              <a href="<%=url%>/jsp/InfoChange.jsp" class="setting">
        ...
        <div class="avt_list_btn">
          <ul class="avt_list">
            <li class="avt_item">
              <a href="#" class="avt_link">Bài viết</a>
            </li>
            <li class="avt_item">
              <a href="#" class="avt_link">Giới thiệu</a>
            </li>
            <li class="avt_item">
              <a href="#" class="avt_link">Bạn bè</a>
            </li>
            <li class="avt_item">
              <a href="#" class="avt_link">Ảnh</a>
            </li>
            <li class="avt_item">
              <a href="#" class="avt_link">Video</a>
            </li>
            <li class="avt_item">
              <a href="#" class="avt_link">Reels</a>
            </li>
            <li class="avt_item">
              <a href="#" class="avt_link">
          ...
          <div class="introduce">
            ...
            <ul>
              <li>
                ...
                <span>Sống tại <b>Tuy Hòa</b></span>
              </li>
              <li>
                <i class="fa-solid fa-heart"></i>
                <span>Đang hẹn hò với <b>Lisa</b></span>
              </li>
              <li>
                <i class="fa-solid fa-clock"></i>
                <span>Tham gia vào tháng 6 năm 2017</span>
              </li>
            </ul>
            <a href="#" class="intro_btn">Chỉnh sửa chi tiết</a>
            <a href="#" class="intro_btn">Thêm nội dung đáng chú ý</a>
          </div>
          ...
          <div class="status">
            <div class="post-input">
              ...
              <span
                ...
                >Nguyên ơi, bạn đang nghĩ gì thế?</span
              >
            </div>
            <div class="post-btn">
              <ul>
              ...
              <ul>
                <li>
                  <div class="button-react">
                    ...
                    <div class="emotions">
                      <span>
                        <i class="fa-solid fa-heart-pulse color_heart emotion" data-emotion="Rung động"></i>
                      </span>
                      <span>
                        <i class="fa-solid fa-face-flushed color_face emotion" data-emotion="Rìa lí man"></i>
                      </span>
                      <span  há">
              ...
              <ul>
                <li>
                  <div class="button-react">
                    ...
                    <div class="emotions">
                      <span>
                        <i class="fa-solid fa-heart-pulse color_heart emotion emotion" data-emotion="Rung động"></i>
                      </span>
                      <span>
                        <i class="fa-solid fa-face-flushed color_face emotion" data-emotion="Rìa lí man"></i>
                      </span>
          ...
          <div class="modal-body">
            <form action="posting" method="POST" enctype="multipart/form-data">
                ...
                <div class="content__post">
                    <textarea name="content" id="content_area" placeholder="Nguyên ơi, bạn đang nghĩ gì thế?"></textarea>
                </div>
